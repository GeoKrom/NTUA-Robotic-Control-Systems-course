...
xhi1_dot = 0.0255*t.^2 - 0.0051*t.^3 + 0.000255*t.^4;
xhi1_2dot = 0.051*t - 0.0153*t.^2 + 0.00102*t.^3;

xhi2 = 1.7 - 0.0085*t.^3 + 0.001275*t.^4 - 0.000051*t.^5; 
xhi2_dot = -0.0255*t.^2 + 0.0051*t.^3 - 0.000255*t.^4;
xhi2_2dot = -0.051*t + 0.0153*t.^2 - 0.00102*t.^3;
